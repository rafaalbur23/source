...
public:
	...
	void Init(SOCKET socket, SSL *ssl, cChar *peerip,uShort peerport,TcpCommApp *tca,bool IsServer);
...
private:
	...
	SSL*			const   m_ssl; // for mutilple ssl connections, one ssl for one client
