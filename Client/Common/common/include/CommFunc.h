...
inline const char* g_GetItemAttrExplain( int v )
{
    switch( v )
    {
    case ITEMATTR_COE_STR: return "Strength";// "Á¦Á¿¼Ó³É"; 
    case ITEMATTR_COE_AGI: return "Agility";// "Ãô½Ý¼Ó³É"; 
    case ITEMATTR_COE_DEX: return "Accuracy";// "×¨×¢¼Ó³É"; 
    case ITEMATTR_COE_CON: return "Constitution";// "ÌåÖÊ¼Ó³É"; 
    case ITEMATTR_COE_STA: return "Spirit";// "¾«Éñ¼Ó³É"; 
    case ITEMATTR_COE_LUK: return "Luck";// "ÐÒÔË¼Ó³É"; 
    case ITEMATTR_COE_ASPD: return "Attack Rate";// "¹¥»÷ÆµÂÊ¼Ó³É"; 
    case ITEMATTR_COE_ADIS: return "Attack Range";// "¹¥»÷¾àÀë¼Ó³É"; 
    case ITEMATTR_COE_MNATK: return "Minimum Attack";// "×îÐ¡¹¥»÷Á¦¼Ó³É"; 
    case ITEMATTR_COE_MXATK: return "Maximum Attack";// "×î´ó¹¥»÷Á¦¼Ó³É"; 
    case ITEMATTR_COE_DEF: return "Defense";// "·ÀÓù¼Ó³É"; 
    case ITEMATTR_COE_MXHP: return "Maximum HP";// "×î´óHP¼Ó³É"; 
    case ITEMATTR_COE_MXSP: return "Maximum SP";// "×î´óSP¼Ó³É"; 
    case ITEMATTR_COE_FLEE: return "Dodge Rate";// "ÉÁ±ÜÂÊ¼Ó³É"; 
    case ITEMATTR_COE_HIT: return "Hit Rate";// "ÃüÖÐÂÊ¼Ó³É"; 
    case ITEMATTR_COE_CRT: return "Critical Hit Rate";// "±¬»÷ÂÊ¼Ó³É"; 
    case ITEMATTR_COE_MF: return "Drop Rate";// "Ñ°±¦ÂÊ¼Ó³É"; 
    case ITEMATTR_COE_HREC: return "HP Recovery";// "HP»Ö¸´ËÙ¶È¼Ó³É"; 
    case ITEMATTR_COE_SREC: return "SP Recovery";// "SP»Ö¸´ËÙ¶È¼Ó³É"; 
    case ITEMATTR_COE_MSPD: return "Movement Speed";// "ÒÆ¶¯ËÙ¶È¼Ó³É"; 
    case ITEMATTR_COE_COL: return "Material Mining Speed";// "×ÊÔ´²É¼¯ËÙ¶È¼Ó³É"; 

    case ITEMATTR_VAL_STR: return "Strength";// "Á¦Á¿¼Ó³É"; 
    case ITEMATTR_VAL_AGI: return "Agility";// "Ãô½Ý¼Ó³É"; 
    case ITEMATTR_VAL_DEX: return "Accuracy";// "×¨×¢¼Ó³É"; 
    case ITEMATTR_VAL_CON: return "Constitution";// "ÌåÖÊ¼Ó³É"; 
    case ITEMATTR_VAL_STA: return "Spirit";// "¾«Éñ¼Ó³É"; 
    case ITEMATTR_VAL_LUK: return "Luck Bonus";// "ÐÒÔË¼Ó³É"; 
    case ITEMATTR_VAL_ASPD: return "Attack Rate";// "¹¥»÷ÆµÂÊ¼Ó³É"; 
    case ITEMATTR_VAL_ADIS: return "Attack Range";// "¹¥»÷¾àÀë¼Ó³É"; 
    case ITEMATTR_VAL_MNATK: return "Minimum Attack";// "×îÐ¡¹¥»÷Á¦¼Ó³É"; 
    case ITEMATTR_VAL_MXATK: return "Maximum Attack";// "×î´ó¹¥»÷Á¦¼Ó³É"; 
    case ITEMATTR_VAL_DEF: return "Defense";// "·ÀÓù¼Ó³É"; 
    case ITEMATTR_VAL_MXHP: return "Maximum HP";// "×î´óHP¼Ó³É"; 
    case ITEMATTR_VAL_MXSP: return "Maximum SP";// "×î´óSP¼Ó³É"; 
    case ITEMATTR_VAL_FLEE: return "Dodge Rate";// "ÉÁ±ÜÂÊ¼Ó³É"; 
    case ITEMATTR_VAL_HIT: return "Hit Rate";// "ÃüÖÐÂÊ¼Ó³É"; 
    case ITEMATTR_VAL_CRT: return "Critical Hit Rate";// "±¬»÷ÂÊ¼Ó³É"; 
    case ITEMATTR_VAL_MF: return "Drop Rate";// "Ñ°±¦ÂÊ¼Ó³É"; 
    case ITEMATTR_VAL_HREC: return "HP Recovery";// "HP»Ö¸´ËÙ¶È¼Ó³É"; 
    case ITEMATTR_VAL_SREC: return "SP Recovery";// "SP»Ö¸´ËÙ¶È¼Ó³É"; 
    case ITEMATTR_VAL_MSPD: return "Movement Speed";// "ÒÆ¶¯ËÙ¶È¼Ó³É"; 
    case ITEMATTR_VAL_COL: return "Material Mining";// "×ÊÔ´²É¼¯ËÙ¶È¼Ó³É"; 

	case ITEMATTR_VAL_PDEF: return "Physical Resist";// "ÎïÀíµÖ¿¹¼Ó³É";
    case ITEMATTR_MAXURE: return "Max Durability";// "×î´óÄÍ¾Ã¶È"; 
    case ITEMATTR_MAXENERGY: return "Max Energy";// "×î´óÄÜÁ¿"; 
    default: return "Unknown tools characteristics";// "Î´ÖªµÀ¾ßÊôÐÔ";
    }
}
...
inline const char* g_GetServerError( int error_code )  // 解析错误码
{
	...
	case ERR_AP_PBANUSER: return "Account has been banned Permanently";// "已经使用了密保卡";
	// End	
	...
	// Add by lark.li 20080825 begin
	case ERR_PT_BANUSER: return "Account has been banned";// "帐号已封停";
	case ERR_PT_PBANUSER: return "Account has been banned Permanently";// "已经使用了密保卡";
	// End
	...
	// Add by lark.li 20080825 begin
	case ERR_MC_BANUSER: return "Account has been banned by MAC IP";// "帐号已封停";
	case ERR_MC_PBANUSER: return "Account has been banned Permanently by MAC IP";// "已经使用了密保卡";
	// End
