...
#define CMD_CM_STORE_CRYSTAL	CMD_CM_BASE + 49
...
#define CMD_MC_STORE_CRYSTAL	CMD_MC_BASE + 69	// EVG ADD: CRYSTAL
...
#define CMD_MT_SPECTATE		CMD_MT_BASE + 12
#define CMD_MT_SPECTATEUPDATE		CMD_MT_BASE + 13
...
#define CMD_PM_BAGOFHOLDING		CMD_PM_BASE + 17
...
#define	CMD_MP_KillNotice CMD_MP_BASE + 33
/*=====================================================================================================
...
#define CMD_MM_UPDATEBAGOFHOLDING		CMD_MM_BASE + 25
#define CMD_MM_SPECTATE		CMD_MM_BASE + 26

#define CMD_MM_DISCORDCARD		CMD_MM_BASE + 27
/*=====================================================================================================
...
//Begin 聊天指令
	...
	#define CMD_PC_KillNotice	CMD_PC_BASE	+ 418 
