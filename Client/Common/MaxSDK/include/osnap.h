...
public:
	...
	virtual TSTR *snapname(int index)=0; // the snap抯 name to be displayed in the UI
	virtual TSTR *tooltip(int index){return NULL;} // the snap抯 name to be displayed in the UI
