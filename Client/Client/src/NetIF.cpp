...
BOOL NetIF::HandlePacketMessage(DataSocket *datasock,LPRPACKET pk)
{
	...
	case CMD_MC_STORE_CRYSTAL: return SC_StoreCrystal(pk);
	...
	case CMD_PC_KillNotice:	 return PC_Say2Dis(pk);
...
// class NetIF
//---------------------------------------------------------------------------
NetIF::NetIF(ThreadPool *comm):TcpClientApp(this,0,comm,true,true),RPCMGR(this),PKQueue(false),m_framedelay(40)
