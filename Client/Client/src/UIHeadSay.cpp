...
*/
    ...
    if ( _nShowTime <= 0 )
    {
        ...
        else if( _IsShowName || g_IsShowNames  )
        {
			...
			//Role name or ship name -> Neck Color
			s_dwNamePartsColors[NAME_INDEX][0] = _dwNameColor;
			const stNetChangeChaPart part = _pOwn->GetPart();
			const int id = part.SLink[enumEQUIP_FACEAPP].sID;
			switch (id) {
			case 6611: { // GM's Necklace in iteminfo
			s_dwNamePartsColors[NAME_INDEX][0] = COLOR_RED;
			} break;
			case 15600: { // GM's Necklace in iteminfo
			s_dwNamePartsColors[NAME_INDEX][0] = COLOR_RED;
			} break;
			case 15601: { // GM's Necklace in iteminfo
			s_dwNamePartsColors[NAME_INDEX][0] = COLOR_GREEN;
			} break;
			case 15602: { // GM's Necklace in iteminfo
			s_dwNamePartsColors[NAME_INDEX][0] = COLOR_BLUE;
			} break;
			case 15603: { // GM's Necklace in iteminfo
			s_dwNamePartsColors[NAME_INDEX][0] = COLOR_BLACK;
			} break;
			case 15604: { // GM's Necklace in iteminfo
			s_dwNamePartsColors[NAME_INDEX][0] = COLOR_GRAY;
			} break;
		}
			...
			/*if (_pOwn->IsNPC())
			{
				s_dwNamePartsColors[NAME_INDEX][0] = COLOR_BLACK; // D3DXCOLOR(109,87,218,1); 
			}*/
