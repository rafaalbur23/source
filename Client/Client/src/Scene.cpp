...
bool CGameScene::_CreateMemory()
{
	...
	if (_stInit.nMaxCha > 0)
		//g_stUISystem.m_sysProp.m_videoProp.bPixel1024 ? _CreateChaArray(_stInit.nMaxCha * 2) : _CreateChaArray(_stInit.nMaxCha);
		if(g_stUISystem.m_sysProp.m_videoProp.bPixel1024 == 0)
		{
	...
	if (_stInit.nMaxObj > 0)
		//g_stUISystem.m_sysProp.m_videoProp.bPixel1024 ? _CreateSceneObjArray(_stInit.nMaxObj * 2) : _CreateSceneObjArray(_stInit.nMaxObj);
		if(g_stUISystem.m_sysProp.m_videoProp.bPixel1024 == 0)
		{
	...
	if (_stInit.nMaxItem > 0)
		//g_stUISystem.m_sysProp.m_videoProp.bPixel1024 ? _CreateSceneItemArray(_stInit.nMaxItem * 2) : _CreateSceneItemArray(_stInit.nMaxItem);
		if(g_stUISystem.m_sysProp.m_videoProp.bPixel1024 == 0)
		{
...
bool CGameScene::_Init()
{
    ...
    _dwTranspObjStateID = 0;
    _dwTranspObjStateNum =  LARGE_RES_X;   
