...
{
	CCreateChaScene* pCreateChaScene = dynamic_cast<CCreateChaScene*>(g_pGameApp->GetCurScene());   // evg add : for remove "Available class for .."
	int iMouseX = g_pGameApp->GetMouseX();
	int iMouseY = g_pGameApp->GetMouseY();
...
bool CCreateChaScene::_InitUI()
{
	...
	// 新手流程界面
	{
		...
		//frmRoleInfo->SetIsShow(true); // evg remove : remove "Character introduction"
		DarkScene( true );
